          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 mb-8 sm:mb-12 pb-8 sm:pb-12 border-b border-gray-700">
            ...
            <div>
              ...
              <ul className="text-gray-300 space-y-2 sm:space-y-3 text-sm">
                ...
                <li>
                  <a
                    href="https://www.helixgeneralhardware.com"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="hover:text-white hover:translate-x-1 transition-all duration-200 inline-block py-1"
                  >
        ...
        <div className="pt-6 sm:pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              <a href="https://www.facebook.com/helixgeneralhardware" className="text-gray-400 hover:text-blue-400 transition-colors duration-200 p-1" aria-label="Visit us on Facebook">
                <span className="sr-only">Facebook</span>
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
              </a>
              <a href="https://www.instagram.com/helixgeneralhardware" className="text-gray-400 hover:text-green-400 transition-colors duration-200 p-1" aria-label="Visit us on Instagram">
